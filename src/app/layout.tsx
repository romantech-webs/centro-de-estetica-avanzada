    ...
    <html lang="es">
      <head>
        ...
        <script
          ...
          data-project-name="CENTRO DE ESTETICA AVANZADA LUMIÉRE"
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="centro-de-estetica-avanzada";` }} />
      </head>
